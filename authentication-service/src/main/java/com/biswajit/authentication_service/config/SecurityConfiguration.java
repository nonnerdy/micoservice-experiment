package com.biswajit.authentication_service.config;



import com.biswajit.authentication_service.filter.JwtAuthenticationFilter;
...
//                        .csrfTokenRequestHandler(new CsrfTokenRequestAttributeHandler()))
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/access/**").permitAll() // Permit access to /auth/**
